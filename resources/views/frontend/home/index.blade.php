                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-2">
                                    <ul class="nav nav-tabs nav-tabs-custom mb-4" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link " <?php echo  null == $categoriestatus ? "active" : "" ?>data-bs-toggle="tab" href="#grid-all" role="tab">All</a>
                                        </li>
                                        <?php echo $categoriestatus ?>
                                        ...
                                        <li class="nav-item">
                                            <form action="{{route('home')}}" method="POST">
                                                ...
                                                <button class="nav-link" type="submit" <?php echo  $categorie->id == $categoriestatus ? "active" : "" ?>>{{$categorie->categorie_name}}</button>
                                            </form>
