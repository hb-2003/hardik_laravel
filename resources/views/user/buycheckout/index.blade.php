                                ...
                                <table class="table table-centered mb-0 table-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="font-size-16 text-truncate"><a href="ecommerce-product-detail.html" class="text-dark"></a></h5>
                                                <p class="text-muted mb-0">$ {{$cartdetails->product_price}} x {{$cartdetails->quantity}}</p>
                                            </td>
