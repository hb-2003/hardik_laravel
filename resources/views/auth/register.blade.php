                                ...
                                <div class="card-body">
                                    <div class="px-3 py-3">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Get your free Vuesy Furniture account now.</p>
                                        </div>
                                        <form class="mt-4 pt-2" action="{{ route('register') }}" method="POST">
                                            ...
                                            <div class="py-1">
                                                <p class="mb-0">By registering you agree to the Vuesy Furniture <a href="#" class="text-primary">Terms of Use</a></p>
                                            </div>
